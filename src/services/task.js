...
function getAllTasksByUserId(userId, withDone) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield task_1.Task.find({
            where: {
                user: { id: userId },
                dueDate: (0, typeorm_1.MoreThanOrEqual)(new Date()),
...
function getAllTasksByUserIdAndDates(userId, minDate, maxDate) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield task_1.Task.find({
            where: {
                user: { id: userId },
                assignment: (0, typeorm_1.MoreThanOrEqual)(minDate) && (0, typeorm_1.LessThanOrEqual)(maxDate)
            },
            relations: ["user", "tag"],
        });
    });
