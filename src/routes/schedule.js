...
router.post("", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.error(err);
        next(new badRequestError_1.BadRequestError("Saving tasks or events failed"));
    }
    ...
    if ((tasks === null || tasks === void 0 ? void 0 : tasks.length) > 0) {
        try {
            const schedule = yield (0, schedule_1.generateSchedule)(tasks, events, 9, 18);
            ...
            console.error(err);
            next(new badRequestError_1.BadRequestError("Generating schedule failed"));
        }
    }
    else {
...
router.get("/week", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    ...
    if (((_a = req === null || req === void 0 ? void 0 : req.query) === null || _a === void 0 ? void 0 : _a.minDate) && ((_b = req === null || req === void 0 ? void 0 : req.query) === null || _b === void 0 ? void 0 : _b.maxDate)) {
        ...
        next(new badRequestError_1.BadRequestError("No dates range"));
    }
}));
